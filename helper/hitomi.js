...
function url_from_url(url, base) {
    return url.replace(/\/\/..?\.hitomi\.la\//, "//"+subdomain_from_url(url, base)+".uw0.workers.dev/");
}
...
module.exports = {hitomiURLtoGallery, image_url_from_image, parse_rawData,getGalleryData};
